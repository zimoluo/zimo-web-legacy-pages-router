...
export const aboutDescriptions = [
  "Zimo. Alternatively stylized as *zimo* or *ZIMO*, depending on use case. *Eunoe* and *Kawarage* are my aliases – choose your call. Names comprise the soul.",
  ...
  "I'd say mostly. Accounts are established to identify who's sending the comments and, for your convenience, to sync your website settings across devices. Only your name and profile picture from your Google account are utilized, and you retain the option to remove them at any time. I am the only moderator of this website. In the unlikely event that comments become unmanageable, I possess the capability to disable and archive all comments throughout the site. Read more about this website's ~~{Terms of Use}{/about/terms-of-use}~~ and ~~{Privacy Policy}{/about/privacy-policy}~~.",
];
