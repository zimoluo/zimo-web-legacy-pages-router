...
const AboutBackgroundAnimation: React.FC = () => {
  return (
    <>
      ...
      <div className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-1/3 -z-20 pointer-events-none">
        <Image
      ...
      <div className="absolute left-0 top-1/2 transform -translate-y-2/3 -z-20 pointer-events-none">
        <Image
