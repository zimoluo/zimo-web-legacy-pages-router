...
const BackgroundImage: React.FC<BackgroundImageProps> = ({ theme }) => {
  ...
  let backgroundImageSrc = backgroundImageMap[theme] || backgroundImageMap["zimo"];

  if (theme === 'about') {
    backgroundImageSrc = settings.backgroundRichness === 'minimal' ? '/about-pane-opaque.svg' : backgroundImageSrc;
  }
